            ...
            <div className="col-11" style={{height:"100%"}}>
                <div className="row no-gutters" style={{width:"100%", height:"100%"}}>
                    <div className="col-2 ptImage d-flex" style={{height:"100%", alignItems:"center", justifyContent:"center", textAlign:'center'}}>
                        <img src={(props.patient.userPhoto ? props.patient.userPhoto : "https://avatars2.githubusercontent.com/u/49351487?s=460&u=a49783af1f3ab38550aae809c9cc4ecdaa432c7c&v=4")} alt="ptPic" className="userPic" style={{height: '70%'}}/>
                    </div>
                    ...
                    <div className="col-3" style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                        <Link className="viewPtMedsButton" to={{pathname: `/user-meds-qr/${props.patient.userId}/${authToken}`, state: {firstName: "Greg",lastName: "Test", userPhoto: (props.patient.userPhoto ? props.patient.userPhoto : "https://avatars2.githubusercontent.com/u/49351487?s=460&u=a49783af1f3ab38550aae809c9cc4ecdaa432c7c&v=4")}}} >View Meds</Link>
                    </div>
                </div>
            </div>
        </div>
